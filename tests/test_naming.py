...
class TestStackNaming:
    ...
    def test_get_stack_name(self):
        ...
        # With run_id
        assert (
            StackNaming.get_stack_name("adaptive", "dev", "run-123")
            == "modelops-adaptive-dev-run-123"
        )
        assert (
            StackNaming.get_stack_name("adaptive", "prod", "exp-001")
            == "modelops-adaptive-prod-exp-001"
        )
    ...
    def test_get_resource_group_name(self):
        ...
        assert (
            StackNaming.get_resource_group_name("staging", "bob.smith")
            == "modelops-staging-rg-bobsmith"
        )
