...
class TestNodePool:
    ...
    def test_fixed_size_pool(self):
        ...
        pool = NodePool(name="workers", vm_size="Standard_DS3_v2", count=5, mode="User")
        assert pool.count == 5
    ...
    def test_autoscaling_pool(self):
        ...
        pool = NodePool(name="workers", vm_size="Standard_DS3_v2", min=2, max=10, mode="User")
    ...
    def test_invalid_xor_sizing(self):
        ...
        with pytest.raises(ValidationError, match="Specify either 'count' OR"):
            NodePool(name="workers", vm_size="Standard_DS3_v2", count=5, min=2, max=10, mode="User")
    ...
    def test_missing_sizing(self):
        ...
        with pytest.raises(ValidationError, match="both 'min' and 'max' are required"):
            NodePool(name="workers", vm_size="Standard_DS3_v2", mode="User")
...
class TestTaint:
    ...
    def test_parse_taint_dict(self):
        ...
        taint = Taint.parse({"key": "workload", "value": "ml", "effect": "PreferNoSchedule"})
...
class TestWorkspaceConfig:
    ...
    def test_valid_workspace_config(self):
        ...
        config = {
            ...
            "kind": "Workspace",
            "metadata": {"name": "test-workspace", "namespace": "test-ns"},
            "spec": {
    ...
    def test_missing_metadata_name(self):
        ...
        config = {"kind": "Workspace", "metadata": {}, "spec": {}}
    ...
    def test_invalid_kind(self):
        ...
        config = {"kind": "InvalidKind", "metadata": {"name": "test"}, "spec": {}}
