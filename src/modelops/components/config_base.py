...
class ConfigModel(BaseModel):
    ...
    @classmethod
    def from_yaml_optional(cls: Type[T], path: Optional[Path]) -> Optional[T]:
        """
    ...
    @classmethod
    def load_or_default(cls: Type[T], path: Optional[Path], **defaults) -> T:
        """
    ...
    def _handle_validation_error(cls, error: ValidationError, path: Path):
        ...
        for err in error.errors():
            ...
            elif 'assertion_error' in error_type or 'value_error' in error_type:
