...
class AdaptiveInfra(pulumi.ComponentResource):
    ...
    def __init__(
        ...
        if storage_stack_ref:
            ...
            k8s.core.v1.Secret(
                ...
                metadata=k8s.meta.v1.ObjectMetaArgs(
                    name="modelops-storage", namespace=infra_namespace
                ),
                string_data={
        ...
        config_map = k8s.core.v1.ConfigMap(
            f"{name}-config",
            metadata=k8s.meta.v1.ObjectMetaArgs(namespace=infra_namespace, name="adaptive-config"),
            data={
                "INFRA_NAME": name,
        ...
        if central_store and central_store.get("kind") == "postgres":
            postgres_dsn, postgres_deployment = self._create_postgres(
                name, infra_namespace, central_store, k8s_provider
            )

        # Create Secret for sensitive data
        secret = k8s.core.v1.Secret(
            f"{name}-secret",
            metadata=k8s.meta.v1.ObjectMetaArgs(namespace=infra_namespace, name="run-secrets"),
            type="Opaque",
            string_data={
        ...
        workers = k8s.apps.v1.Deployment(
            ...
            spec=k8s.apps.v1.DeploymentSpecArgs(
                ...
                selector=k8s.meta.v1.LabelSelectorArgs(match_labels={"app": "adaptive-worker"}),
                        ...
                        containers=[
                            k8s.core.v1.ContainerArgs(
                                    ...
                                    k8s.core.v1.EnvVarArgs(
                                        ...
                                        value_from=k8s.core.v1.EnvVarSourceArgs(
                                            secret_key_ref=k8s.core.v1.SecretKeySelectorArgs(
                                                name="run-secrets", key="POSTGRES_DSN"
                                            )
                                        ),
                                    ),
                                    k8s.core.v1.EnvVarArgs(
                                        name="DASK_SCHEDULER", value=scheduler_address
                                    ),
                                    k8s.core.v1.EnvVarArgs(
                                        name="ALGORITHM",
                                        value=config.get("algorithm", "optuna"),
                                    ),
                                    k8s.core.v1.EnvVarArgs(name="NAMESPACE", value=infra_namespace),
                                ],
                                ...
                                resources=k8s.core.v1.ResourceRequirementsArgs(
                                    requests=worker_resources.get(
                                        "requests", {"cpu": "100m", "memory": "256Mi"}
                                    ),
                                    limits=worker_resources.get(
            ...
            opts=pulumi.ResourceOptions(
                ...
                parent=self,
                depends_on=[postgres_deployment]
                if postgres_deployment
                else [],  # Workers depend on postgres if it exists
            ),
        )
        ...
        if run_smoke_tests:
            ...
            if postgres_dsn:
                test_env.append(k8s.core.v1.EnvVarArgs(name="POSTGRES_DSN", value=postgres_dsn))
    ...
    def _create_postgres(
        ...
        postgres_secret = k8s.core.v1.Secret(
            ...
            metadata=k8s.meta.v1.ObjectMetaArgs(namespace=namespace, name="postgres-secret"),
        ...
        pvc = k8s.core.v1.PersistentVolumeClaim(
            f"{name}-postgres-pvc",
            metadata=k8s.meta.v1.ObjectMetaArgs(namespace=namespace, name="postgres-data"),
        ...
        postgres = k8s.apps.v1.Deployment(
            ...
            spec=k8s.apps.v1.DeploymentSpecArgs(
                replicas=1,
                selector=k8s.meta.v1.LabelSelectorArgs(match_labels={"app": "postgres"}),
                template=k8s.core.v1.PodTemplateSpecArgs(
                    metadata=k8s.meta.v1.ObjectMetaArgs(
                        labels={"app": "postgres", "modelops.io/component": "postgres"}
                    ),
                    spec=k8s.core.v1.PodSpecArgs(
                        ...
                        security_context=k8s.core.v1.PodSecurityContextArgs(
                            run_as_non_root=True, run_as_user=999, fs_group=999
                        ),
                        containers=[
                            k8s.core.v1.ContainerArgs(
                                name="postgres",
                                ...
                                env=[
                                    ...
                                    k8s.core.v1.EnvVarArgs(
                                        ...
                                        value_from=k8s.core.v1.EnvVarSourceArgs(
                                            secret_key_ref=k8s.core.v1.SecretKeySelectorArgs(
                                                name="postgres-secret", key="password"
                                            )
                                        ),
                                    ),
                                    k8s.core.v1.EnvVarArgs(
        ...
        postgres_svc = k8s.core.v1.Service(
            ...
            spec=k8s.core.v1.ServiceSpecArgs(
                ...
                ports=[k8s.core.v1.ServicePortArgs(port=5432, target_port=5432, name="postgres")],
                type="ClusterIP",
            ),
            opts=pulumi.ResourceOptions(provider=k8s_provider, parent=self),
        )
