...
class SmokeTest(pulumi.ComponentResource):
    ...
    def __init__(
        ...
        tests: list[str],
        k8s_provider,
        env: list[k8s.core.v1.EnvVarArgs] | None = None,
        env_from: list[k8s.core.v1.EnvFromSourceArgs] | None = None,
                            ...
                            k8s.core.v1.ContainerArgs(
                                ...
                                volume_mounts=[
                                    k8s.core.v1.VolumeMountArgs(
                                        name="test-script", mount_path="/scripts"
                                    )
                                ],
                        ...
                        volumes=[
                            k8s.core.v1.VolumeArgs(
                                ...
                                config_map=k8s.core.v1.ConfigMapVolumeSourceArgs(
                                    name=f"smoke-test-{name}-script", default_mode=0o755
                                ),
                            )
                        ],
                    ),
    ...
    def _build_test_script(self, tests: list[str]) -> str:
        ...
        """
        script_parts = ["#!/bin/sh", "set -e", "echo 'Starting smoke tests...'", ""]
        ...
        script_parts.extend(
            ["echo ''", "echo '✓ All smoke tests completed successfully!'", "exit 0"]
        )
